...
module.exports = {
    ...
    // 添加外卖评论
    insertShopComment: config.host + 'MicroPlatform/comment/insertShopComment', 
    // 查询订单
    ...
    // 添加外卖分类
    insertFoodsClassUrl: config.host + 'MicroPlatform/foodgoods/insertFoodsClass',
    // 修改外卖分类
    ...
    // 验证手机验证码(商家修改信息时使用)
    verificationSmsUrl: config.host + 'MicroPlatform/user/verificationSms',
    // 查询查询经纬度
    getMapUrl: config.host + 'MicroPlatform/address/getMap',  
    // 订单成功手机短信通知
    getOrderSmsUrl: config.host + 'MicroPlatform/order/getOrderSms',
    // 微信支付
    wxPay: config.host + 'MicroPlatform/shop/wxPay',
    //  修改营业状态
    updateOutShopSale: config.host + 'MicroPlatform/shop/updateOutShopSale',
    // 根据shop_code获取商品
    getGoodsByCodeUrl: config.host + 'MicroPlatform/goods/getGoodsByCode',
    //添加满赠
    insertReductionInGoods: config.host + 'MicroPlatform/coupon/insertReductionInGoods',
    //查询满赠
    getReductionInGoods: config.host + 'MicroPlatform/coupon/getReductionInGoods',
    // 删除满赠
    deleteReduction: config.host + 'MicroPlatform/coupon/deleteReduction',      
    // 修改满赠
    updateReductionInGoods: config.host + 'MicroPlatform/coupon/updateReductionInGoods',  
    // 获取满赠的信息
    getReductionInGoodsById: config.host + 'MicroPlatform/coupon/getReductionInGoodsById', 
    //查询待付款
    getNoPayOrder: config.host + 'MicroPlatform/order/getNoPayOrder', 
    // 去付款
    getPayOrder: config.host + 'MicroPlatform/order/getPayOrder', 
    // 取消订单
    updateRelevanceOrder: config.host + 'MicroPlatform/order/updateRelevanceOrder', 
    // 获取骑手信息
    getHorseManByUUID: config.host + 'MicroPlatform/order/getHorseManByUUID', 
    //可提现金额查询 
    getPayAccount: config.host + 'MicroPlatform/shop/getPayAccount', 
    // 物流公司
    getCompany: config.host + 'MicroPlatform/transInfo/getCompany', 
